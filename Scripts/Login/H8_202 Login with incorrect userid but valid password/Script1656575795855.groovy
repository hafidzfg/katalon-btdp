...
WebUI.setText(findTestObject('LoginPage_CURA Healthcare Service/input_Username_username'), 'abcdef')

WebUI.setEncryptedText(findTestObject('LoginPage_CURA Healthcare Service/input_Password_password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')
