...
WebUI.setText(findTestObject('LoginPage_CURA Healthcare Service/input_Username_username'), username)

WebUI.setText(findTestObject('LoginPage_CURA Healthcare Service/input_Password_password'), password)
